...
public class dynamicwebtable {
	...
	public static void main(String[] args) {
		...
		/*List<WebElement> l = driver.findElements(By.xpath("//table[@class='table table-bordered table-hover']//tr"));
			
			System.out.println(l.size());*/
			
			//read data from table
			
			int norows = driver.findElements(By.xpath("//table[@class='table table-bordered table-hover']//tr")).size();
			
			for(int j=1;j<norows;j++) {
			
			String s1 = driver.findElement(By.xpath("//table[@class='table table-bordered table-hover']//tbody/tr["+j+"]/td[2]")).getText();
			String str = driver.findElement(By.xpath("//table[@class='table table-bordered table-hover']//tbody/tr["+j+"]/td[3]")).getText();
